package com.github.zhoujinshi.proxy.intercept.common;
  ...
  public void beforeRequest(Channel clientChannel, HttpRequest httpRequest,
    ...
    if (requestProto.getHost().equals(inetSocketAddress.getHostString()) &&
      ...
      if (httpRequest.uri().matches("^.*/ca.crt.*$")) {  //下载证书
        ...
        HttpResponse httpResponse = new DefaultHttpResponse(HttpVersion.HTTP_1_1,
            HttpResponseStatus.OK);
        String html = "<html><body><div style=\"margin-top:100px;text-align:center;\"><a href=\"ca.crt\">proxyRoot ca.crt</a></div></body></html>";
