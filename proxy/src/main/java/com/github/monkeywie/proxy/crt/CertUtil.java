package com.github.zhoujinshi.proxy.crt;
...
public class CertUtil {
  ...
  public static X509Certificate genCert(String issuer, PrivateKey caPriKey, Date caNotBefore,
      ...
      String... hosts) throws Exception {
        /* String issuer = "C=CN, ST=GD, L=SZ, O=lee, OU=study, CN=proxyRoot";
  ...
  public static void main(String[] args) throws Exception {
    ...
    File caCertFile = new File("e:/ssl/proxy.crt");
    if(caCertFile.exists()){
      caCertFile.delete();
    }
    Files.write(Paths.get(caCertFile.toURI()),
        CertUtil.genCACert(
            "C=CN, ST=GD, L=SZ, O=lee, OU=study, CN=proxy",
            new Date(),
