export default {
  ...
  extension: {
    conditions: 'Notes',
    conditionsContent: 'When using the extension for the first time, you must install a CA certificate randomly generated by Proxy Down. Click Install below and follow the instructions. If a Proxy Down CA certificate has been installed, you will be prompted to delete the old CA certificate.',
    install: 'Install',
