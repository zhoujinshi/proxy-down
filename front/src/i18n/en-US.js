export default {
    ...
    extension: {
        ...
        conditionsContent: 'When using the expansion module for the first time, you must install a CA certificate randomly generated by Proxy Down, click the install button below and press the system to confirm the installation. The program will detect whether the Proxy Down CA certificate has been installed in the operating system before installation. (Tip:If it detects the installation, it will prompt to delete the corresponding old CA certificate)',
        install: 'Install',
    ...
    about: {
        project: {
            title: 'Project',
            content: 'proxy-Down is an open source, free software based on the software\'s high-speed download kernel and extensions to easily and quickly download the required resources.',
